...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen rounded-0 md:rounded-lg md:min-h-full md:shadow-lg md:bg-white rounded-0 flex-col items-center text-start justify-center bg-[#f8f5f0] p-4 w-full">
      ...
      <div className="md:px-5 space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full rounded-md bg-[#5D3A00] p-3 text-center font-medium text-white hover:bg-[#7a4f26] focus:outline-none"
          >
            Log in
          </button>
        </form>
